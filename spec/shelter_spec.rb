...
RSpec.describe Shelter do
  ...
  describe 'over_capacity' do
    it 'determines if the shelter is over capacity based on the given capacity and current population' do
  ...
  #Iteration 4
  describe 'adopt' do
    it 'will remove pets from shelter until it is no longer over capacity' do
      shelter = Shelter.new('Denver Animal Shelter', 3)
      shelter.add_pet('Salem')
      shelter.add_pet('Beethoven')
      shelter.add_pet('Spot')
      shelter.add_pet('Jonesy')
      shelter.add_pet('Riley')
      shelter.add_pet('Shoresy')
